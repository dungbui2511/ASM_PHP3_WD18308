  ...
  <div class="container">
    <div class="row">
      <div
        ...
        <h1 class="h2 mb-4">Bài viết liên quan đến <mark>{{$cateName}}</mark></h1>
        ...
        <article class="card mb-4">
          ...
          <div class="card-body">
            ...
            <ul class="card-meta list-inline">
              ...
              <li class="list-inline-item">
                <i class="ti-calendar"></i>{{ $cate->created_at->format('d M, Y') }}
              </li>
              <li class="list-inline-item">
                <ul class="card-meta-tag list-inline">
                @foreach(explode(',',$cate->tag->name) as $tag)
            ...
            <p>
            @if (strlen($cate->content) > 200)
            {!! substr($cate->content, 0, 200) !!} ...
            @else
                {!! $cate->content !!}
            @endif
            </p>
            <a href="{{route('post.by_cate', ['cate_id' => $cate->id]) }}" class="btn btn-outline-primary">Read More</a>
          </div>
        </article>
        @endforeach
        <!-- <article class="card mb-4">
